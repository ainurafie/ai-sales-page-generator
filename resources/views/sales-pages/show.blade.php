...
<x-app-layout>
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-2">
                <a href="{{ route('sales-pages.export', $salesPage) }}"
                   class="inline-flex items-center gap-1.5 rounded-lg border border-indigo-200 bg-indigo-50 px-3 py-2 text-sm font-medium text-indigo-700 hover:bg-indigo-100">
    ...
    <div class="py-6 bg-gray-100">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="rounded-2xl bg-white shadow-2xl ring-1 ring-gray-200 overflow-hidden">
                <div class="bg-gray-100 border-b border-gray-200 px-4 py-2.5 flex items-center gap-2">
                    ...
                    <div class="flex-1 mx-4">
                        <div class="bg-white rounded-md px-3 py-1 text-xs text-gray-500 text-center">
                            {{ Str::slug($salesPage->product_name) }}.com
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white">
                    ...
                    @if (!$content)
                        ...
                        <div class="p-12 text-center">
                            <p class="text-gray-500">Konten tidak dapat di-parse sebagai landing page.</p>
                            <pre class="mt-6 text-left text-xs bg-gray-50 p-4 rounded overflow-auto max-h-96">{{ $salesPage->generated_content }}</pre>
                        </div>
                    @else
